...
export default function Signin() {
  ...
  return(
    <div>
      ...
      <div className="hidden lg:block bg-[#edf5d7] h-screen fixed lg:w-1/3">
        <div id="carouselExampleIndicators" class="carousel slide relative" data-bs-ride="carousel">
          ...
          <div class="carousel-inner relative w-full overflow-hidden">
            <div class="carousel-item active float-left w-full h-screen">
      ...
      <div className="lg:ml-[33.3%]">
        <div className="pt-10 sm:pt-16 lg:pt-10 xl:pt-[5rem]">
          ...
          <div className="mx-5 mb-20 sm:mx-auto sm:px-12 md:px-16 lg:px-10 mt-6 sm:shadow-md sm:max-w-[28rem] md:max-w-[32rem] lg:max-w-[29rem] sm:rounded-lg py-5 lg:pt-14 lg:pb-20 sm:pt-9 sm:pb-16">
            ...
            <form className="mt-5">
              <div>
                ...
                <br />
                <input className="border focus:outline-[#056424] focus:bg-white text-[#464646] text-sm w-full mt-1 h-12 rounded-md px-2 placeholder:text-xs" type="email" placeholder="Enter your email address"/>
              ...
              <div>
                <p className="text-sm text-[#464646] mt-5 text-center">No account yet? <Link href="/auth/signup"><span className="text-[#A3DC22] hover:text-[#056424] hover:underline cursor-pointer">Register here</span></Link></p>
              </div>
            </form>
          </div>
        </div>
