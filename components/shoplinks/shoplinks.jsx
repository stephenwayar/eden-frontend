  ...
  return(
    <>
      <div className="max-w-[100rem] 2xl:max-w-[100rem] mx-auto px-4 md:px-8">
        <div>
          <Link href="/shop">
            <div className="mt-5 overflow-hidden cursor-pointer md:mt-8 xl:mt-12 w-full h-52 sm:h-72 md:h-[20rem] lg:h-[25rem]">
        ...
        <div className='mt-4 md:mt-6 xl:mt-8'>
          <div className='sm:grid sm:grid-cols-2 gap-4 md:gap-6 xl:gap-8'>
            <Link href="/shop/men">
              <div className="overflow-hidden cursor-pointer w-full h-52 sm:h-72 md:h-[20rem] lg:h-[25rem]">
            ...
            <Link href="/shop/men">
              <div className="overflow-hidden mt-4 sm:mt-0 cursor-pointer w-full h-52 sm:h-72 md:h-[20rem] lg:h-[25rem]">
